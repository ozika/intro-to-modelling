...
author: "Ondrej Zika"
institute: "Institute for Systems Neuroscience"
date: "5th May 2026"
format:
  revealjs:
    ...
    code-overflow: wrap
    footer: "Ondrej Zika | Institute for Systems Neuroscience | 5th May 2026"
server: shiny
execute:
  echo: false
  warning: false
...
## {.splash background-color="#f5f7fa"}

::: {style="margin-top: 80px; text-align: center;"}

<h1 style="font-size:1.75em; color:#2c3e50; line-height:1.3;">
A brief introduction to<br>computational modelling
</h1>

<h3 style="color:#666; font-weight:normal; margin-top:0.4em;">
...
3. **Specifying** a model — mathematics and R code
...
df <- data.frame(
  ...
  fill  = c("#3d5a7a", "#3d5a7a", "#888888", COL_MODEL)
)
arrows <- data.frame(
  x1 = c(1.6, 4.4, 3.0, 3.0),
  y1 = c(2.0, 2.0, 2.75, 1.35),
  x2 = c(2.4, 3.6, 3.0, 3.0),
  y2 = c(2.0, 2.0, 2.35, 1.65),
  type = c("a","b","c","d")
)
ggplot(df) +
  geom_tile(aes(x, y, fill = I(fill)),
            width = 1.4, height = 0.6, colour = "white", linewidth = 2) +
  geom_text(aes(x, y, label = label), colour = "white",
            fontface = "bold", size = 4.2, lineheight = 1.2) +
  geom_segment(data = arrows,
               aes(x = x1, y = y1, xend = x2, yend = y2),
               arrow = arrow(length = unit(0.25, "cm")),
               colour = "#555555", linewidth = 1.2) +
  xlim(0.1, 5.9) + ylim(0.5, 3.5) +
  theme_void()
```
